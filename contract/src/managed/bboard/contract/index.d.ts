...
export type ImpureCircuits<PS> = {
  ...
  submitFeedback(context: __compactRuntime.CircuitContext<PS>,
                 ratingScore_0: bigint,
                 category_0: string,
                 feedbackDigest_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
}
...
export type Ledger = {
  ...
  readonly lastCategory: { is_some: boolean, value: string };
  readonly lastFeedbackDigest: Uint8Array;
}
