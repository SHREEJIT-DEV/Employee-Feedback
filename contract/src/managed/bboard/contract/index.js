...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      submitFeedback: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`submitFeedback: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const ratingScore_0 = args_1[1];
        const category_0 = args_1[2];
        const feedbackDigest_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        if (!(typeof(ratingScore_0) === 'bigint' && ratingScore_0 >= 0n && ratingScore_0 <= 255n)) {
          __compactRuntime.typeError('submitFeedback',
        ...
        if (!(feedbackDigest_0.buffer instanceof ArrayBuffer && feedbackDigest_0.BYTES_PER_ELEMENT === 1 && feedbackDigest_0.length === 32)) {
          __compactRuntime.typeError('submitFeedback',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_7.toValue(ratingScore_0).concat(_descriptor_4.toValue(category_0).concat(_descriptor_0.toValue(feedbackDigest_0))),
            alignment: _descriptor_7.alignment().concat(_descriptor_4.alignment().concat(_descriptor_0.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
    ...
    this.impureCircuits = {
      ...
      submitFeedback: this.circuits.submitFeedback
    };
                                    ...
                                    __compactRuntime.convertFieldToBytes(32,
                                                                         _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                                   ...
                                                                                                                                   [
                                                                                                                                    ...
                                                                                                                                    { popeq: { cached: true,
                                                                                                                                               result: undefined } }]).value),
                                                                         'bboard.compact line 38 char 48'));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                            ...
                                                            __compactRuntime.convertFieldToBytes(32,
                                                                                                 _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                                                           ...
                                                                                                                                                           [
                                                                                                                                                            ...
                                                                                                                                                            { popeq: { cached: true,
                                                                                                                                                                       result: undefined } }]).value),
                                                                                                 'bboard.compact line 45 char 47'))),
  ...
  _submitFeedback_0(context,
                    partialProofData,
                    ratingScore_0,
                    category_0,
                    feedbackDigest_0)
  {
    __compactRuntime.assert(ratingScore_0 >= 1n, 'Rating must be at least 1');
    __compactRuntime.assert(ratingScore_0 <= 5n, 'Rating must be at most 5');
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_2 = this._some_0(category_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(7n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(feedbackDigest_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
